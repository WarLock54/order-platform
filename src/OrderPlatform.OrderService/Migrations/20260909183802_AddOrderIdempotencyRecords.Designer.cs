...
namespace OrderPlatform.OrderService.Migrations
{
    ...
    [Migration("20260909183802_AddOrderIdempotencyRecords")]
    partial class AddOrderIdempotencyRecords
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderPlatform.OrderService.Infrastructure.OrderIdempotencyRecord", b =>
                {
            ...
            modelBuilder.Entity("OrderPlatform.OrderService.Saga.OrderSagaState", b =>
                {
                    b.Property<Guid>("CorrelationId")
                        .HasColumnType("uuid");
